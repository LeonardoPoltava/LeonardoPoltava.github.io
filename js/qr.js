var qrcode = function () {
    ...
    function k(h, b, e, d, c, a) {
        ...
        this.buildFunctionPattern = function () {
            var d = this.DimensionForVersion, c = new I(d);
            c.setRegion(0, 0, 9, 9);
            ...
            for (var e = this.alignmentPatternCenters.length, b = 0; b < e; b++)
                for (var a = this.alignmentPatternCenters[b] - 2, h = 0; h < e; h++)
                    0 == b && (0 == h || h == e - 1) || b == e - 1 && 0 == h || c.setRegion(this.alignmentPatternCenters[h] -
                            2, a, 5, 5);
    ...
    function z(h, b, e, d, c, a, l, m, f) {
        ...
        this.transformPoints2 = function (c, d) {
            for (var e = c.length, b = 0; b < e; b++) {
                var h = c[b], a = d[b], l = this.a13 * h + this.a23 * a + this.a33;
    ...
    function Q(h) {
        ...
        this.sizeOfBlackWhiteBlackRun = function (b, e, d, c) {
            ...
            for (var m = Math.abs(d - b), f = Math.abs(c - e), q = -m >> 1, k = e < c ? 1 : -1, x = b < d ? 1 : -1, v = 0, t = b, a = e; t != d; t += x) {
                ...
                if (3 == v)
                    return c = t - b, e = a - e, Math.sqrt(c *
                            c + e * e);
                q += f;
                if (0 < q) {
                    if (a == c)
        ...
        this.sizeOfBlackWhiteBlackRunBothWays = function (b, e, d, c) {
            var a = this.sizeOfBlackWhiteBlackRun(b, e, d, c), h = 1;
            d = b - (d - b);
        ...
        this.calculateModuleSizeOneWay = function (b, e) {
            var d = this.sizeOfBlackWhiteBlackRunBothWays(Math.floor(b.X),
                    Math.floor(b.Y), Math.floor(e.X), Math.floor(e.Y)), c = this.sizeOfBlackWhiteBlackRunBothWays(Math.floor(e.X), Math.floor(e.Y), Math.floor(b.X), Math.floor(b.Y));
        ...
        this.createTransform = function (b, e, d, c, h) {
            ...
            if (null != c) {
                ...
                p = e.X - b.X + d.X, c = e.Y - b.Y + d.Y, f = a = h;
        ...
        this.processFinderPatternInfo = function (b) {
            var e = b.TopLeft, d = b.TopRight;
            b = b.BottomLeft;
            var c = this.calculateModuleSize(e, d, b);
            if (1 > c)
                throw"Error";
            var h = this.computeDimension(e, d, b, c), a = k.getProvisionalVersionForDimension(h), m = a.DimensionForVersion - 7, f = null;
    ...
    function T(a) {
        ...
        this.readVersion = function () {
            ...
            var e = this.bitMatrix.Dimension, d = e - 17 >> 2;
            if (6 >= d)
            ...
            this.parsedVersion = k.decodeVersionInformation(d);
            if (null !=
                    this.parsedVersion && this.parsedVersion.DimensionForVersion == e)
                return this.parsedVersion;
            throw"Error readVersion";
        };
        this.readCodewords = function () {
            var b = this.readFormatInformation(), d = this.readVersion(), c = H.forReference(b.DataMask), b = this.bitMatrix.Dimension;
            ...
            for (var c = d.buildFunctionPattern(), a = !0, h = Array(d.TotalCodewords), m = 0, f = 0, g = 0, k = b - 1; 0 < k; k -= 2) {
                ...
                for (var x = 0; x < b; x++)
                    for (var v = a ? b - 1 - x : x, t = 0; 2 > t; t++)
                        c.get_Renamed(k - t, v) || (g++, f <<= 1, this.bitMatrix.get_Renamed(k -
    ...
    function w(a, b) {
        ...
        this.multiply1 = function (c) {
            ...
            var d = this.coefficients, b = d.length;
            c = c.coefficients;
        ...
        this.divide = function (c) {
            ...
            for (var d = this.field.Zero, b = this, e = c.getCoefficient(c.Degree), e = this.field.inverse(e); b.Degree >= c.Degree && !b.Zero; )
                var a = b.Degree - c.Degree,
                        h = this.field.multiply(b.getCoefficient(b.Degree), e), f = c.multiplyByMonomial(a, h), a = this.field.buildMonomial(a, h), d = d.addOrSubtract(a), b = b.addOrSubtract(f);
            return[d, b]
        }
    }
    function n(a) {
    ...
    function S() {
        ...
        this.selectBestPatterns = function () {
            ...
            if (3 < a) {
                for (var b = 0, e = 0, d = 0; d < a; d++)
                    var c =
                            this.possibleCenters[d].EstimatedModuleSize, b = b + c, e = e + c * c;
                var p = b / a;
                this.possibleCenters.sort(function (c, d) {
                    var b = Math.abs(d.EstimatedModuleSize - p), e = Math.abs(c.EstimatedModuleSize - p);
            ...
            for (var b = null, e = 0; e < a; e++) {
                ...
                if (d.Count >= K)
                    if (null == b)
                        ...
                        return this.hasSkipped = !0, Math.floor((Math.abs(b.X - d.X) - Math.abs(b.Y - d.Y)) / 2)
            }
            return 0
        };
        ...
        this.findFinderPattern = function (a) {
            var b;
            this.image = a;
            var e = g.height, d = g.width, c = Math.floor(3 * e / (4 * W));
            c < L && (c = L);
                        ...
                        if (4 == b)
                            if (this.foundPatternCross(l)) {
                                if (b = this.handlePossibleCenter(l, m, f))
                                    c = 2, this.hasSkipped ? h = this.haveMultiplyConfirmedCenters() :
                                ...
                                l[0] = l[2], l[1] = l[3], l[2] = l[4], l[3] = 1, l[4] = 0, b = 3;
                        else
                            l[++b]++;
                    else
                        l[b]++;
    ...
    function R(a, b, e, d, c, f, l) {
        ...
        this.crossCheckVertical = function (c, d, b, a) {
            var e = this.image, h = g.height, f = this.crossCheckStateCount;
            f[0] = 0;
            f[1] = 0;
            f[2] = 0;
        ...
        this.find = function () {
            for (var c, b = this.startX, h = this.height, f = b + d, l = e + (h >> 1), p = [0, 0, 0], k = 0; k < h; k++) {
                ...
                if (this.foundPatternCross(p) && (c = this.handlePossibleCenter(p, n, f), null != c))
                    return c
            }
    ...
    function X(a, b, e) {
        ...
        this.getRomanAndFigureString = function (b) {
            var c = "", d = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".split("");
            do
                if (1 < b) {
                    var a = this.getNextBits(11);
                    var e = a % 45, c = c + d[Math.floor(a / 45)], c = c + d[e];
                    b -= 2
                } else
                    1 == b && (a = this.getNextBits(6), c += d[a], --b);
            while (0 <
                    b);
            return c
        };
    ...
    k.VERSIONS = [new k(1, [], new f(7, new a(1, 19)), new f(10, new a(1, 16)), new f(13, new a(1, 13)), new f(17, new a(1, 9))), new k(2, [6, 18], new f(10, new a(1, 34)), new f(16, new a(1, 28)), new f(22, new a(1, 22)), new f(28, new a(1, 16))), new k(3, [6, 22], new f(15, new a(1, 55)), new f(26, new a(1, 44)), new f(18, new a(2, 17)), new f(22, new a(2, 13))), new k(4, [6, 26], new f(20, new a(1, 80)), new f(18,
        ...
        new k(12, [6, 32, 58], new f(24, new a(2, 92), new a(2, 93)), new f(22, new a(6, 36), new a(2, 37)), new f(26, new a(4, 20), new a(6, 21)), new f(28, new a(7, 14), new a(4, 15))), new k(13, [6, 34, 62], new f(26, new a(4, 107)), new f(22, new a(8, 37), new a(1, 38)), new f(24, new a(8, 20), new a(4, 21)), new f(22, new a(12, 11), new a(4, 12))), new k(14, [6, 26, 46, 66], new f(30, new a(3, 115), new a(1, 116)), new f(24, new a(4, 40), new a(5, 41)), new f(20, new a(11, 16), new a(5, 17)), new f(24, new a(11, 12), new a(5, 13))), new k(15, [6, 26, 48, 70], new f(22, new a(5,
            ...
            166], new f(30, new a(20, 117), new a(4, 118)), new f(28, new a(40, 47), new a(7, 48)), new f(30, new a(43, 24), new a(22, 25)), new f(30, new a(10, 15), new a(67, 16))), new k(40, [6, 30, 58, 86, 114, 142, 170], new f(30, new a(19, 118), new a(6, 119)), new f(28, new a(18, 47), new a(31, 48)), new f(30, new a(34, 24), new a(34, 25)), new f(30, new a(20, 15), new a(61, 16)))];
    ...
    z.squareToQuadrilateral = function (a, b, e, d, c, f, g, m) {
        ...
        c = a - e + c - g;
        f = d - f;
        var n = p * h - k * f, h = (c * h - k * l) / n, l = (p * l - c * f) / n;
    ...
    var N = [[21522, 0], [20773, 1], [24188, 2], [23371, 3], [17913, 4], [16590, 5], [20375, 6], [19104, 7], [30660, 8], [29427,
            9], [32170, 10], [30877, 11], [26159, 12], [25368, 13], [27713, 14], [26998, 15], [5769, 16], [5054, 17], [7399, 18], [6608, 19], [1890, 20], [597, 21], [3340, 22], [2107, 23], [13663, 24], [12392, 25], [16177, 26], [14854, 27], [9396, 28], [8579, 29], [11994, 30], [11245, 31]], B = [0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4];
    ...
    var Y = new C(0, 1, "L"), Z = new C(1, 0, "M"), aa = new C(2, 3, "Q"), ba = new C(3, 2, "H"), O = [Z, Y, ba, aa];
    G.getDataBlocks = function (a, b, e) {
        ...
        for (var h = 0, f = 0; f < c.length; f++) {
            var g = c[f];
            for (b = 0; b < g.Count; b++) {
                var k = g.DataCodewords, q = d.ECCodewordsPerBlock + k;
                e[h++] = new G(k, Array(q))
            }
        }
        ...
        this.runEuclideanAlgorithm = function (a, e, d) {
            ...
            for (var b = this.field.One, f = this.field.Zero, h = this.field.Zero, g = this.field.One; e.Degree >= Math.floor(d / 2); ) {
                ...
                for (f = this.field.inverse(f); e.Degree >= a.Degree && !e.Zero; ) {
                    var k = e.Degree - a.Degree, r = this.field.multiply(e.getCoefficient(e.Degree), f), g = g.addOrSubtract(this.field.buildMonomial(k, r));
    ...
    E.decode = function (a) {
        ...
        for (var d = Array(d), f = 0, h = 0; h < b.length; h++) {
            var c = b[h], g = c.Codewords, k = c.NumDataCodewords;
            E.correctErrors(g,
                    k);
            for (c = 0; c < k; c++)
                d[f++] = g[c]
    ...
    var g = {imagedata: null, width: 0, height: 0, qrCodeSymbol: null, debug: !1, maxImgSize: 1048576, sizeOfDataLengthInfo: [[10, 9, 8, 8], [12, 11, 16, 10], [14, 13, 16, 12]], callback: null, vidSuccess: function (a) {
            ...
            b.getUserMedia ? b.getUserMedia({video: e,
                audio: !1}, g.vidSuccess, g.vidError) : b.webkitGetUserMedia ? (g.webkit = !0, b.webkitGetUserMedia({video: e, audio: !1}, g.vidSuccess, g.vidError)) : b.mozGetUserMedia && (g.moz = !0, b.mozGetUserMedia({video: e, audio: !1}, g.vidSuccess, g.vidError))
        }, decode: function (a) {
            if (0 == arguments.length) {
                if (g.canvas_qr2) {
                    ...
                    b = document.getElementById("qr-canvas"), e = b.getContext("2d");
                g.width = b.width;
                g.height = b.height;
            ...
            d.onload = function () {
                ...
                var a = document.createElement("canvas"), b = a.getContext("2d"), e = d.height, f = d.width;
        ...
        decode_url: function (a) {
            ...
            var b = (new Date).getTime(), e = g.grayScaleToBitmap(g.grayscale());
            if (g.debug) {
    ...
    g.orderBestPatterns = function (a) {
        ...
        var e = b(a[0], a[1]), d = b(a[1], a[2]), c = b(a[0], a[2]);
    ...
    reader.onload = function () {
        ...
        qrcode.callback = function (res) {
            if (res instanceof Error) {
                ...
                let form = priceInput.parentNode;
